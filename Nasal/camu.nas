...
var init = func {
   ...
   setprop("/systems/CAMU/radio/selected-channel-n", 1);
   setprop("/systems/CAMU/radio[1]/selected-channel-n", 2);
   };

   
setlistener("/systems/CAMU/radio/selected-channel-n", rad1tune);
setlistener("/systems/CAMU/channel-list/channel[8]/frequency", rad1tune);
setlistener("/systems/CAMU/channel-list/channel[9]/frequency", rad1tune);
setlistener("/systems/CAMU/radio[1]/selected-channel-n", rad2tune);
setlistener("/systems/CAMU/channel-list/channel[8]/frequency", rad2tune);
setlistener("/systems/CAMU/channel-list/channel[9]/frequency", rad2tune);
